...
class PendingSurveyScreen extends StatefulWidget {
  const PendingSurveyScreen({Key? key}) : super(key: key);

  @override
  State<PendingSurveyScreen> createState() => _PendingSurveyScreenState();
}

class _PendingSurveyScreenState extends State<PendingSurveyScreen> {
  int? userID;
                       ...
                       return InkWell(
                         onTap: () {
                           Navigator.of(context)
                             ...
                             return RadioSurveyScreen(id!, heading!,"pending");
                           }));
                         },
                         child: Container(
                           margin: const EdgeInsets.only(
